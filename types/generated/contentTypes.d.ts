...
export interface ApiInfinitySliderInfinitySlider extends Schema.SingleType {
  collectionName: 'infinity_sliders';
  info: {
    singularName: 'infinity-slider';
    pluralName: 'infinity-sliders';
    displayName: 'Infinity_slider';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::infinity-slider.infinity-slider',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    data: Attribute.DynamicZone<['project.project-info']>;
